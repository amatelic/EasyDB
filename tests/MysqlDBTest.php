...
class MysqlDbTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->database = new Mysql($conf, $table); 
        $this->databaseFields = new Mysql($conf, $table ,array("email", "age")); 
    }
    ...
    {
       $this->database->where("username","=", "tilen")->delete(); 
       $quire = $this->database->get();
       $this->assertEquals(3, count($quire)); 
